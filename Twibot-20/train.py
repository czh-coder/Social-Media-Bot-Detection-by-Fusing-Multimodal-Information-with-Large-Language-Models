...
def train(epoch,model,criterion,optimizer,scheduler,train_dataloader):
    all_predictions = []
    all_targets = []
    epoch_loss = 0.0
    i=0
...
def main(seed):
    ...
    for epoch in range(epochs):
        ...
        train(epoch,model,criterion,optimizer,scheduler,train_dataloader)
        ...
        if acc > best_acc:
            ...
            best_f1 = f1
            best_epoch = epoch+1
            save_path = './trained_model_param/all/gpt/MY_MODEL.pt'
...
if __name__ == "__main__":
    ...
    des_tensor,tweets_tensor,semantic_tensor,num_prop,category_prop,edge_index,edge_type,labels,train_idx,val_idx,test_idx=dataset.get_data2(semantic_type='gpt')
